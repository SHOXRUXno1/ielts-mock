"""Seed Practice Set B Test 5 Writing.

Task 1: diagrams — stages in the development of simple cooking equipment.
Task 2: rapid urban economic development vs countryside — problems + solutions.

Wording is taken from the printed paper (p.126). The teaching tip strips
and strategy boxes around those tasks are not part of the exam and are omitted.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_b_t5_writing.py
"""
...
TASK2_STATEMENT = (
    ...
    "development. This has resulted in much higher standards of living in "
    "urban areas but not in the countryside.\n\n"
    "This situation may bring some problems for the country as a whole."
)
TASK2_QUESTION = "What are these problems?\n\nHow might they be reduced?"
TASK2_ESSAY_TYPE = "problem_solution"
...
async def seed(db: AsyncSession) -> None:
    ...
    await db.commit()
    print(f"  Task 1  diagrams {CHART_IMAGE_URL.format(test=TEST_NUMBER)}  min 150 words")
