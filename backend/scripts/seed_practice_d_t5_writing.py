"""Seed Practice Set D Test 5 Writing.

Task 1: London survey — bar charts + line graph (worst/best things; major problems).
Task 2: Education after school — positive or negative development (opinion).

Wording from the printed paper (pp.148-149). Tip strips omitted.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_d_t5_writing.py
"""
...
TASK1_DESCRIPTION = (
    "The bar charts and line graph below show the results of a "
    "survey conducted over a three-year period to discover what "
    "people who live in London think of the city.\n\n"
...
TASK2_STATEMENT = (
    "In many countries these days, the number of people continuing "
    "their education after school has increased, and the range of "
    "courses available at universities and colleges has also "
    "increased."
)
TASK2_QUESTION = (
