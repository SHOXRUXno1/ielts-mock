"""Seed Practice Set B Test 1 Writing.

Task 1: US energy production vs consumption, 1950-2000, with projections to 2025.
Task 2: reducing city traffic by reducing the need to travel.

Wording is taken from the printed paper (pp.33 and 35). The teaching
'strategy' boxes around those tasks are not part of the exam and are omitted.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_b_t1_writing.py
"""
...
TASK1_DESCRIPTION = (
    "The graph below compares figures for the production and consumption of "
    "energy in the US from 1950 to 2000. It also predicts figures for 2025."
)

TASK2_STATEMENT = (
    "The only way to reduce the amount of traffic in cities today is by "
    "reducing the need for people to travel from home for work, education "
    "or shopping."
)
