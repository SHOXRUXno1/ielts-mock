"""Sit a Practice Set B test three times in memory and check the marking.

Same gates as check_practice_a_scoring.py, pointed at practice-set-b.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\check_practice_b_scoring.py 1
"""
