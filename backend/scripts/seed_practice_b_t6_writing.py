"""Seed Practice Set B Test 6 Writing.

Task 1: tables — world population and regional distribution 1950–2050.
Task 2: safe alternatives to fossil fuels as the top global priority —
agree / disagree.

Wording is taken from the printed paper (p.141). The teaching tip strips
and strategy boxes around those tasks are not part of the exam and are omitted.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_b_t6_writing.py
"""
...
TASK2_STATEMENT = (
    ...
    "should be the most important global priority today."
)
...
async def seed(db: AsyncSession) -> None:
    ...
    await db.commit()
    print(f"  Task 1  tables {CHART_IMAGE_URL.format(test=TEST_NUMBER)}  min 150 words")
