"""Publish a Practice Set A test, refusing to publish a broken one.

Runs the same checks POST /admin/tests/{id}/publish runs and only flips the flag
when they all pass, so a test can never go live half-authored.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\publish_practice_a.py 1
"""
