"""Check a Practice Set E test end to end before anyone sits it.

Same gates as verify_practice_a.py, pointed at practice-set-e.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\verify_practice_e.py 1
"""
