"""Seed Practice Set D Test 4 Writing.

Task 1: water clock process diagram.
Task 2: causes + solutions — age discrimination in employment.

Wording from the printed paper (pp.128-129). Tip strips omitted.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_d_t4_writing.py
"""
...
TASK2_STATEMENT = (
    "In some countries, it can be very difficult for people over the "
    "age of 50 to get good jobs, despite their experience."
)
TASK2_QUESTION = (
    "What do you think are the causes of this problem, and what "
