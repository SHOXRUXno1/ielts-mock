"""Check a Practice Set C test end to end before anyone sits it.

Same gates as verify_practice_a.py, pointed at practice-set-c.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\verify_practice_c.py 1
"""
