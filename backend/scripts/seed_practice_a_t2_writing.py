"""Seed Practice Set A Test 2 Writing, Task 1 and Task 2.

Task 1: table of how the UK unemployed spent their time in 1982.
Task 2: two questions on animal experimentation.

Idempotent: the writing section is cleared before it is written.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_a_t2_writing.py
"""
...
TASK1_DESCRIPTION = (
    "The chart below shows how the UK unemployed spent their time in the "
    "year 1982."
)

TASK2_STATEMENT = (
    "Do you believe that experimentation on animals for scientific purposes "
    "is justified?"
)
TASK2_QUESTION = "Are there any alternatives to animal experimentation?"
