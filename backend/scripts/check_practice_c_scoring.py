"""Sit a Practice Set C test three times in memory and check the marking.

Same gates as check_practice_a_scoring.py, pointed at practice-set-c.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\check_practice_c_scoring.py 1
"""
...
from seed_practice_c_common import BOOK_SLUG  # noqa: E402
