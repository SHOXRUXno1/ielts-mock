"""Seed Practice Set C Test 5 Writing.

Task 1: graph and bar chart — average monthly rainfall and temperature
        for one region of East Africa.
Task 2: double question — meat production vs crop production.

Wording is taken from the printed paper (p.112). The teaching tip strips
around those tasks are not part of the exam and are omitted.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_c_t5_writing.py
"""
...
TASK2_QUESTION = (
    "What measures could be taken to reduce the world's meat consumption? "
    "What kinds of problem might such measures cause?"
)
