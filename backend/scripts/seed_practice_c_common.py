"""Shared plumbing for seeding Practice Set C (Longman Practice Tests Plus 3).
...
BOOK_NAME = "IELTS Practice Set C"
BOOK_SLUG = "practice-set-c"
SOURCE_BOOK = "IELTS Practice Tests Plus 3"
...
PLUS3_ROOT = Path(r"C:\Users\brawl\Desktop\Ielts boosters\IELTS Practice Test Plus 3")
PLUS3_PDF = PLUS3_ROOT / "IELTS practice tests plus 3 .pdf"
PLUS3_AUDIO = PLUS3_ROOT / "CD1"
...
def data_dir(test_number: int) -> Path:
    return DATA_ROOT / f"practice_c_t{test_number}"


AUDIO_URL = "/media/audio/practice_c_t{test}_listening_p{part}.mp3"
MAP_IMAGE_URL = "/media/images/practice_c_t{test}_listening_map.png"
CHART_IMAGE_URL = "/media/images/practice_c_t{test}_writing_task1.png"
SNOWGUN_IMAGE_URL = "/media/images/practice_c_t{test}_reading_snowgun.png"
...
async def get_test(db: AsyncSession, test_number: int) -> Test:
    ...
    if test is None:
        raise SystemExit(
            ...
            "run scripts/seed_practice_c_bootstrap.py first"
        )
    return test
