"""Seed Practice Set C Test 2 Writing.

Task 1: process diagram — a method of producing leather goods.
Task 2: children's vs adults' social behaviour — double question.

Wording is taken from the printed paper (p.53). The teaching tip strips
around those tasks are not part of the exam and are omitted.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_c_t2_writing.py
"""
...
TASK2_QUESTION = (
    "What are the main differences between young children's social behaviour "
    "and that of adults? To what extent are the changes that take place good?"
)
