"""Shared plumbing for seeding Practice Set E (Peter May (Oxford)).
...
BOOK_NAME = "IELTS Practice Set E"
BOOK_SLUG = "practice-set-e"
SOURCE_BOOK = "Peter May Oxford IELTS Practice Tests"
...
PETERMAY_ROOT = Path(
    r"C:\Users\brawl\Desktop\Ielts boosters\Peter May Practice Tests"
)
PETERMAY_PDF = PETERMAY_ROOT / "IELTS Practice Tests.pdf"
PETERMAY_AUDIO = PETERMAY_ROOT / "Peter May Oxford IELTS & Audio"
...
def data_dir(test_number: int) -> Path:
    return DATA_ROOT / f"practice_e_t{test_number}"


AUDIO_URL = "/media/audio/practice_e_t{test}_listening_p{part}.mp3"
MAP_IMAGE_URL = "/media/images/practice_e_t{test}_listening_map.png"
CHART_IMAGE_URL = "/media/images/practice_e_t{test}_writing_task1.png"
UNUSED_IMAGE_URL = "/media/images/practice_e_t{test}_reading_snowgun.png"
...
async def get_test(db: AsyncSession, test_number: int) -> Test:
    ...
    if test is None:
        raise SystemExit(
            ...
            "run scripts/seed_practice_e_bootstrap.py first"
        )
    return test
