"""Check a Practice Set D test end to end before anyone sits it.

Same gates as verify_practice_a.py, pointed at practice-set-d.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\verify_practice_d.py 1
"""
...
# Windows consoles often default to cp1251; answer keys include £ etc.
...
from seed_practice_d_common import BOOK_SLUG  # noqa: E402
