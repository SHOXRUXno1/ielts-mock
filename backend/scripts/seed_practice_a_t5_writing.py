"""Seed Practice Set A Test 5 Writing, Task 1 and Task 2.

Task 1: paired diagrams of the oxygen / carbon dioxide exchange between plants
and people.
Task 2: agree/disagree on money spent on space exploration.

Idempotent: the writing section is cleared before it is written.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_a_t5_writing.py
"""
...
TASK1_DESCRIPTION = (
    "The diagrams below show how humans and plants interact to produce oxygen "
    "and carbon dioxide."
)

TASK2_STATEMENT = (
    "With all the troubles in the world today, money spent on space "
    "exploration is a complete waste. The money could be better spent on "
    "other things."
)
