"""Seed Practice Set E Test 2 Writing.

Source: Peter May Oxford IELTS Practice Tests, Test 2 (pp.63-66).

Task 1: diagram — environmental issues raised by a product over
        its life cycle.
Task 2: opinion — credit cards and personal debts.
...
Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\seed_practice_e_t2_writing.py
"""
...
TASK2_STATEMENT = (
    "Many people are using credit cards or loans to run up huge "
    "personal debts that they may be unable to repay. It should "
    "therefore be made more difficult for individuals to borrow "
    "large amounts of money."
)
TASK2_QUESTION = "What are your opinions on this?"
