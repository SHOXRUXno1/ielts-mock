"""Sit a Practice Set D test three times in memory and check the marking.

Same gates as check_practice_a_scoring.py, pointed at practice-set-d.

Usage:
    cd backend
    .\\venv\\Scripts\\python scripts\\check_practice_d_scoring.py 1
"""
